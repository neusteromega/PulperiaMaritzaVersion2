...
public class AdminSQLiteOpen extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase BaseDatos) {
        ...
        BaseDatos.execSQL("CREATE TABLE Productos (PrdID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, PrdNombre TEXT NOT NULL, PrdTipo1 TEXT NOT NULL, PrdTipo2 TEXT, PrdPrecio1 TEXT NOT NULL, PrdPrecio2 TEXT, CatID INTEGER NOT NULL, PrvID INTEGER NOT NULL, PrdImagen INTEGER NOT NULL, FOREIGN KEY(CatID) REFERENCES Categorias(CatID), FOREIGN KEY(PrvID) REFERENCES Proveedores(PrvID));");
