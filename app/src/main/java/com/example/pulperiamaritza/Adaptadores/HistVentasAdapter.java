...
public class HistVentasAdapter extends RecyclerView.Adapter<HistVentasAdapter.RecyclerHolder> implements View.OnClickListener {
    private List<HistVentasItemsModel> items; //Creamos una lista de tipo HistVentasItemsModel
    ...
    public HistVentasAdapter(List<HistVentasItemsModel> items) { //Método Constructor en el cual inicializamos la lista "items"
        this.items = items;
    }
    ...
    public RecyclerHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.items_histventas, parent, false); //Inflamos la vista que utilizaremos para las tarjetas del RecyclerView
    ...
    @Override
    public void onBindViewHolder(@NonNull HistVentasAdapter.RecyclerHolder holder, int position) {
        HistVentasItemsModel item = items.get(position); //Creamos una lista de tipo HistVentasItemsModel llamada "item" la cual igualamos a la otra lista "items" extrayendo posición por posición
